...
export const fallbackCaseStudies: CaseStudyItem[] = [
  ...
  { id: "cs2", slug: "putahracsa-hua-hin", client_name: "Putahracsa Hua Hin",
    ...
    relationship_years: 10, hero_image_url: null,
    summary: "Five Star Alliance boutique resort, 67 rooms, multiple F&B outlets, managed remotely from Bangkok and Samui.",
    challenge: "Design-focused boutique hotel where technology must be invisible to guests but reliable for operations. Multiple F&B outlets need integrated POS. Located 200km from Bangkok with limited local IT expertise.",
    solution: "Full IT operations managed remotely from Bangkok/Samui: POS integration across 3 F&B outlets and the spa, property-wide WiFi, Microsoft 365, domain & hosting, and on-site visits as needed. Hardware sourced through SiS.",
